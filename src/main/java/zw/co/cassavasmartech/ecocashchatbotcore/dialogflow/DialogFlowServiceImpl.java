...
public class DialogFlowServiceImpl implements DialogFlowService {
    ...
    private WebhookResponse pinresetUsecaseHandler(WebhookRequest webhookRequest) {
        ...
        if(customer.isPresent())
            ...
            prompt = String.format("Welcome back %s%s hope you are having a beautiful %s so far. What can I do for you today?", customer.get().getFirstName(),new String(Character.toChars( 0x1F349)),DialogFlowUtil.getTimeOfDay());
