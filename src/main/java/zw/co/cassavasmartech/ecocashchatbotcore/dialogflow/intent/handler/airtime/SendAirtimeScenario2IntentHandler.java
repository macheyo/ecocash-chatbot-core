...
@Slf4j
public class SendAirtimeScenario2IntentHandler extends IntentHandlerAdapter {
    @Override
    public WebhookResponse getWebhookResponse(WebhookRequest... webhookRequest) {
        ...
        return DialogFlowUtil.getResponse(webhookRequest[0],
                ...
                DialogFlowUtil.createTicket(webhookRequest[0],UseCase.BUY_AIRTIME),
                UseCase.BUY_AIRTIME);
        else return DialogFlowUtil.getResponse(webhookRequest[0],
                DialogFlowUtil.promptProcessor(22,webhookRequest[0],customer),
                new Object[]{},
                UseCase.BUY_AIRTIME);
    }
}
